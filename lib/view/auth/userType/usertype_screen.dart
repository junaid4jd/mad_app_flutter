...
import 'package:mad_app_flutter/view/auth/login/login_screen.dart';
import 'package:mad_app_flutter/view/auth/welcome/welcome_screen.dart';
              ...
              child: ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>
                        LoginScreen(userType: 'Users',)));

                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(builder: (context) => LoginScreen()),
                    // );
                  }, child: Text('Patient', style: buttonStyle)),
            ),
          SizedBox(
