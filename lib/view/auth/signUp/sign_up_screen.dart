...
import 'package:mad_app_flutter/model/input_validator.dart';
                              ...
                              onPressed: () async {
                                ...
                                if (_inputValidator.validateName(
                                  ...
                                  Fluttertoast.showToast(
                                    ...
                                    _clinicNameControoler.text) !=
                                    'success' &&
                                    _clinicNameControoler.text.isNotEmpty) {
                                  Fluttertoast.showToast(
                                      msg: "Invalid Clinic Name",
                                      toastLength: Toast.LENGTH_SHORT,
                                      gravity: ToastGravity.BOTTOM,
                                      timeInSecForIosWeb: 1,
                                      backgroundColor: Colors.black,
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  alignment: Alignment.centerLeft,
                                  //  height: size.height*0.08,
                                  child: Center(child: Text('Upload Image', style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
                                ),
                              ),
                            ],),
                        ),
