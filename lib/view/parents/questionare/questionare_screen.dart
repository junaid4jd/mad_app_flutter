...
class QuestionareScreen extends StatefulWidget {
  final int number;
  final String type;
  const QuestionareScreen({super.key,
...
class _QuestionareScreenState extends State<QuestionareScreen> {
  ...
  getQuestion() async {
    ...
    final FirebaseAuth _auth = FirebaseAuth.instance;
    FirebaseFirestore.instance.collection(widget.type == 'MChat' ? 'MChat' : 'SCQ').where('id',isEqualTo:widget.number.toString()).get().then((value) {

      if(value.docs.isEmpty) {

        for(int i=1; i<=10 ; i++) {
          FirebaseFirestore.instance.collection(widget.type == 'MChat' ? 'MChatData' : 'SCQData').doc(_auth.currentUser!.uid+i.toString()).get().then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: showResult == 'yes' && _question == null ? Text('Report', style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),) :  Center(
          child: Row(
      ...
      showResult == 'yes' && _question == null ? Column(children: [
        ...
        new CircularPercentIndicator(
          ...
          progressColor:
          total <= 4 ? Colors.green :
          total > 4 && total <= 6 ?Colors.yellow :
          total > 6 ? Colors.red :
          Colors.blue,
        ),
        SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(childName, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500,fontSize: 14),),
                ),
              ),
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(age.toString() + ' years old', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500,fontSize: 14),),
                ),
              ),
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(gender, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500,fontSize: 14),),
                ),
              ),
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(total.toString() + ' / 10', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500,fontSize: 14),),
                ),
              ),
            ],
          ),
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    total <= 4 ? 'This score indicates Low risk of autism' :
                    total > 4 && total <= 6 ?  'This score indicates Medium risk of autism' :
                    total > 6 ? 'This score indicates High risk of autism'  : 'Calculation Autism'
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    total <= 4 ? 'Low risk don\'t need to take your child to doctor' :
                    total > 4 && total <= 9 ? 'You should take your child to his/her doctor to follow up screening.You can also seek early intervention services for your child.' :
                    total == 10 ? 'You must have to take your child to his/her doctor to follow up screening.You can also seek early intervention services for your child.'  :
                    'Calculation Autism'
      ...
      _question == null && showResult == '' ? Center(
          ...
          child: Column(children: [
            ...
            Center(
              child: Container(
                ...
                child: Text( widget.number.toString()+'/10', style: TextStyle(color: Colors.blue, fontSize: 17,fontWeight: FontWeight.bold),),
              ),
            ),
            SizedBox(
              height: size.height*0.02,
            ...
            Center(
              child: Container(
                width: size.width*0.9,
                child: Text( 'Q ${_question!.id.toString()} : ' + _question!.question.toString(), style: TextStyle(color: Colors.blue, fontSize: 17,fontWeight: FontWeight.bold),),
              ),
            ),
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        ...
                        setState(() {
                          selected = _question!.options![index].toString();
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                          selectedIndex == index.toString() ?
                          primaryColor : lightButtonGreyColor,
                          ...
                          child: Row(
                            children: [
                              Radio(
                                ...
                                value: selectedIndex == index.toString() ? false : true,
                                groupValue: false,
                                onChanged: (value) {
                                  // setState(() {
                                  //   _site = value!;
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style:  TextStyle(
                                      fontSize: 15, color:
                                  selectedIndex == index.toString() ? Colors.white :
                      ...
                      onPressed: () async {
                        ...
                        if(widget.number == 1) {
                          ...
                          Navigator.push(
                            context,
                            PageRouteBuilder(
                              pageBuilder: (c, a1, a2) => QuestionareScreen(number: widget.number-1, type: widget.type,),
                              transitionsBuilder: (c, anim, a2, child) => FadeTransition(opacity: anim, child: child),
                              transitionDuration: Duration(milliseconds: 100),
                            ),
                          );
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if(selected == '') {
                          ...
                          var snackBar = SnackBar(content: Text('Choose one of the option'
                          ...
                          await FirebaseFirestore.instance.collection(widget.type == 'MChat' ? 'MChatData' : 'SCQData').doc(_auth.currentUser!.uid+widget.number.toString()).set({
                            'uid': _auth.currentUser!.uid,
                            'type': widget.type == 'MChat' ? 'MChat' : 'SCQ',
                            'id': widget.number.toString(),
                            'answer': selected.toString() == _question!.answer.toString() ? 1 : 0,
                          }).then((value) {
                            setState(() {
                              isLoading = false;
                            });
