...
import 'package:mad_app_flutter/view/doctor/doctorReportDetail/doctor_report_detail_screen.dart';
import 'package:mad_app_flutter/view/reports/report_detail_screen.dart';
...
class ParentBookingDetailScreen extends StatefulWidget {
  ...
  @override
  _ParentBookingDetailScreenState createState() => _ParentBookingDetailScreenState();
}
...
class _ParentBookingDetailScreenState extends State<ParentBookingDetailScreen> {
  ...
  getData() async {
    ...
    FirebaseFirestore.instance.collection('Users').where('uid',isEqualTo: widget.parentUid).get().then((value) {
      setState(() {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Center(child: Text(
                  widget.evaluation == 0 ? 'Not Evaluated Yet' :
                  'Doctor Skin Disease Detection', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w600,fontSize: 15),)),
              ),
            ),
            ...
            new CircularPercentIndicator(
              ...
              progressColor:
              widget.evaluation <= 4 ? Colors.green :
              widget.evaluation > 4 && widget.evaluation <= 6 ?Colors.yellow :
              widget.evaluation > 6 ? Colors.red :
              Colors.blue,
            ),
            SizedBox(
              height: size.height*0.02,
