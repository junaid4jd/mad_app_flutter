...
import 'package:mad_app_flutter/model/firebase_auth.dart';
import 'package:mad_app_flutter/view/parents/bookingDetail/parent_booking_detail_screen.dart';
...
class ParentBookingScreen extends StatefulWidget {
  ...
  const ParentBookingScreen({Key? key, }) : super(key: key);
        ...
        child: MaterialApp(
          ...
          home: Scaffold(
            ...
            body: TabBarView(
              children: [
                StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("Bookings").where("parentId", isEqualTo: _auth.currentUser!.uid.toString() ).where("bookingStatus", isEqualTo: "Pending" ).snapshots(),
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => ParentBookingDetailScreen(
                                          childName: snapshot.data!.docs[index]["parentName"].toString(),
                                            ...
                                            Container(
                                              ...
                                              child:  ClipRRect(
                                                ...
                                                child:  CachedNetworkImage(
                                                  ...
                                                  width: size.width ,
                                                  fit: BoxFit.cover,
                                                  imageUrl: snapshot.data!.docs[index]["childImage"].toString(),
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        "Clinic : " + snapshot.data!.docs[index]["doctorName"].toString()
                                                        , style: TextStyle(
                ...
                StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("Bookings").where("parentId", isEqualTo: _auth.currentUser!.uid.toString() ).where("bookingStatus", isEqualTo: "Confirmed" ).snapshots(),
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      return Center(child: CircularProgressIndicator(
                        strokeWidth: 1,
                ...
                StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("Bookings").where("parentId", isEqualTo: _auth.currentUser!.uid.toString() ).where("bookingStatus", isEqualTo: "Cancelled" ).snapshots(),
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      return Center(child: CircularProgressIndicator(
                        strokeWidth: 1,
