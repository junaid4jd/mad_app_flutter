...
class _SpecialistDetailScreenState extends State<SpecialistDetailScreen> {
  ...
  String name = '' , email = '',uid = '',childName = '', age = '',confidence = '',
      image = '', showReport = '', Case = '', childAdvice = '', date = '',selectedIndex = '';
  String text = '';
  String score = '';
        ...
        for(int i=0; i<value.docs.length ; i++) {
          ...
          setState(() {
            _reports.add({
              ...
              'patientName': value.docs[i]['patientName'].toString(),
              'image': value.docs[i]['image'].toString(),
                                          ...
                                          Navigator.push(
                                            ...
                                            PageRouteBuilder(
                                              pageBuilder: (c, a1, a2) => ReportDetailScreen(
                                                name: snapshot.data!.docs[index]["patientName"].toString(),
                                                Case: snapshot.data!.docs[index]["case"].toString(),
